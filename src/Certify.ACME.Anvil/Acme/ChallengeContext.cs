...
namespace Certify.ACME.Anvil.Acme
{
    ...
    /// </summary>
    /// <seealso cref="Certify.ACME.Anvil.Acme.IChallengeContext" />
    internal class ChallengeContext : EntityContext<Challenge>, IChallengeContext
    {
        ...
        /// The challenge.
        /// </returns>
        public async Task<Challenge> Validate(object payload = null)
        {
            var resp = await Context.HttpClient.Post<Challenge>(Context, Location, payload ?? new { }, true);
